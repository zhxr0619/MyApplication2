...
//        System.out.println("解密后文字: \r\n" + target);
        ...
        HaoBaseRequestBean requestBean=new HaoBaseRequestBean();
        requestBean.setApplyId("000008");
        requestBean.setCorpCustIP("100.0.0.10");
        requestBean.setCorpCustNo("0000008");
        requestBean.setOpType("HB101");
        requestBean.setRequestTime("20140429151000");
        String source1=new Gson().toJson(requestBean);
        System.out.println("\r加密前文字：\r\n" + source1);

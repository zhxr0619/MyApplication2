 ...
 *
 */
public class CoopSecurityUtil2 {
...
//					logger.error("异常", e);
	...
	public static void main(String[] args) throws Exception {
		...
		PrivateKey howubyPriKey = CoopSecurityUtil2.loadPrivateKey("E:/temp/coop_test_key/howbuy_private.pfx", "howbuytest");
		PublicKey howbuyPubKey = CoopSecurityUtil2.loadPublicKey("E:/temp/coop_test_key/howbuy_public.crt");

		PrivateKey merchantPriKey = CoopSecurityUtil2.loadPrivateKey("E:/temp/coop_test_key/merchant_private.pfx", "merchanttest");
		PublicKey merchantPubKey = CoopSecurityUtil2.loadPublicKey("E:/temp/coop_test_key/merchant_public.crt");
		...
		//加密
		byte[] encryptData = CoopSecurityUtil2.encrypt(howbuyPubKey, data.getBytes("UTF-8"));
		...
		// 加签
		byte[] signature = CoopSecurityUtil2.generateSignature(encryptData,merchantPriKey);
		System.out.println("sign:" + Base64.encodeBase64String(signature));



		//验签
		System.out.println("sign status:" + CoopSecurityUtil2.verifySignature(encryptData, merchantPubKey, signature));

		// 解密
		byte[] decryptData = CoopSecurityUtil2.decrypt(howubyPriKey,encryptData);
		System.out.println("decryptData:" + new String(decryptData, "UTF-8"));

//		String encrypt="";
//		String sign="";

//		{"content":{"sign":"","data":""},"contentType":"2"}

		String encrypt="";
